  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        { 
          role: "system", 
          content: "You are a helpful assistant that summarizes product reviews. Provide the summary in Turkish and ensure it is under 300 words. Do not mention that you are an AI or that this is an AI-generated summary. Directly provide the summary of the reviews."
        },
        { 
          role: "user", 
          content: prompt 
